...
<div class="col-md-4">
    <div class="card">
        ...
        <img class="card-img-top" width="400" height="200" src="images/<?= $file_gambar ?>" alt="<?= $item['title'] ?>">
        <div class="card-body">
            <h4 class="card-title"><?= $item['title']?></h4>
            <p class="card-text"><?= $item['excerpt']?></p>
            <a href="index.php?front_folder=post&file=single&id_post=<?= $item['id_post']?>" class="btn btn-warning">Read More..</a>
        </div>
    </div>
</div>
<?php
